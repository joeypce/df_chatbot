...
if __name__ == "__main__":
    ...
    data2 = pandas.read_csv('data/acc2.csv', names=colnames)
    ...
    while(counter < totalcount):
        try:
            ...
            queryinput = str(data2.question[counter])        #get test question
            queryinput = queryinput.replace("\r\n", "")
            pyperclip.copy(queryinput)                      #copy
            querybar.send_keys(Keys.CONTROL + "v")          #paste
            ...
            answer = browser.find_element_by_xpath(
                "//*[@id='test-console']/div[2]/div[4]/div[4]/console-response-content/div[2]/div[2]/div/div/div/div/span/span").text
            questionnumber = data2.answer[counter]
